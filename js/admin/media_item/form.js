...
function validate_form(lang) {
	 ...
	 if (document.getElementById('media_section_id').value==0)
	 {
		 show('dv_media_section_id_false');
		 document.getElementById('media_section_id').focus();
		 error=error+1;
	 } else {
		 hide('dv_media_section_id_false');
	 }	
