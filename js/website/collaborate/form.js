function submitform()
{
  document.frm_collaborate.submit();
}
...
function validate_form(lang) {
	 ...
	 if (document.getElementById('type').value.replace(/^\s+|\s+$/g, '')=="")
	 {
		 document.getElementById('type').className = "input_error";
		 //show('dv_type_false');
		 error=error+1;
	 }
	 else
	 {
		 document.getElementById('type').className = "input_success";
	 ...
	 {
		 document.getElementById('message').className = "input_error";
		 //show('dv_message_false');
		 error=error+1;
	 }
	 else
	 {
		 document.getElementById('message').className = "input_success";
		 
		 //hide('dv_message_false');
	 }
