		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					...
					<div id="login-block">
					<div class="block">
								<form name="frm_partner_login" id="frm_partner_login" action="<?php echo base_url().$this->lang->lang();?>/partner/authourize" method="post" enctype='multipart/form-data'>
								<label>
									<span><?php echo $this->lang->line('username'); ?></span>
									<input type="text" name="username" id="username"  />
								</label>
								<label>
									<span><?php echo $this->lang->line('password'); ?><a href="<?php echo base_url().$this->lang->lang().'/partner/forgetPassword';?>"><?php echo $this->lang->line('forgot_you_password'); ?></a></span>
