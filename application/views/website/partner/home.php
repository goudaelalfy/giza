		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					<div class="hint"><?php echo $this->lang->line('partners_welcome'); ?></div>
					<h1><?php echo $this->lang->line('welcome').' '.$this->session->userdata('partner_session')->username; ?></h1>
					<div class="main-body">
                                    ...
                                    <div style="width:33%; float:left" align="center">
                                        <a href="<?php echo base_url().$this->lang->lang();?>/partner/profile"><img src="<?php echo base_url();?>css/old/images/Giza-img-editprofile.jpg" border="0" /></a>
                                    </div>
                                    
                                    <div style="width:33%; float:left" align="center">
                                        <a href="<?php echo base_url().$this->lang->lang();?>/partner/survey"><img src="<?php echo base_url();?>css/old/images/Giza-partner-sur.jpg" border="0" /></a>	
                                    </div>
