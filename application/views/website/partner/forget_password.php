		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					...
					<div id="login-block">
					<div class="block">
							<form name="frm_partner_forget_password" id="frm_partner_forget_password" action="<?php echo base_url().$this->lang->lang();?>/partner/sendPassword" method="post" enctype='multipart/form-data'>
								
								<label>
									<span><?php echo $this->lang->line('contact_email'); ?></span>
									<input type="text" name="contact_email" id="contact_email"  />
								</label>
								<label>
									<span><a href="<?php echo base_url().$this->lang->lang().'/partner/login';?>"><?php echo $this->lang->line('login'); ?></a></span>
								</label>
								<div class="clear"></div>
