		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					...
					<div id="login-block">
					<div class="block">
							<form name="frm_candidate_forget_password" id="frm_candidate_forget_password" action="<?php echo base_url().$this->lang->lang();?>/candidate/sendPassword" method="post" enctype='multipart/form-data'>
								...
								<label>
									<span><a href="<?php echo base_url().$this->lang->lang().'/candidate/login';?>"><?php echo $this->lang->line('login'); ?></a></span>
								</label>
								<div class="clear"></div>
