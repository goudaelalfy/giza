		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					<div class="hint"><?php //echo $this->lang->line('candidates_welcome'); ?></div>
					<h1><?php echo $this->lang->line('welcome').' '.$this->session->userdata('candidate_session')->username; ?></h1>
					<div class="main-body">
								
                                     <div style="width:100%; height:50px;"></div>
                                     <div style="width:100%; height:50px; font-size:18px; color:#7d7d7d" align="center">What would you like to do?</div>
                                     <div style="width:26%; float:left" align="center">
                                         <a href="<?php echo base_url().$this->lang->lang();?>/candidate/profile"><img src="<?php echo base_url();?>css/old/images/edit_profile.png" border="0" /></a>
                                     </div>
                                     <div style="width:25%; float:left" align="center">
                                         <a href="<?php echo base_url().$this->lang->lang();?>/job/applied"><img src="<?php echo base_url();?>css/old/images/applyed_jobs.png" border="0" /></a>	
                                     </div>
                                     
                                     <div style="width:25%; float:left" align="center">
                                         <a href="<?php echo base_url().$this->lang->lang();?>/job"><img src="<?php echo base_url();?>css/old/images/recent_jobs.png" border="0" /></a>	
                                     </div>
                                     
                                     <div style="width:24%; float:left" align="center">
                                         <a href="<?php echo base_url().$this->lang->lang();?>/job/cart"><img src="<?php echo base_url();?>css/old/images/job_cart.png" border="0" /></a>	
                                     </div>
