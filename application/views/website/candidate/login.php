		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					...
					<div id="login-block">
					<div class="block">
								<form name="frm_candidate_login" id="frm_candidate_login" action="<?php echo base_url().$this->lang->lang();?>/candidate/authourize" method="post" enctype='multipart/form-data'>
								<label>
									<span><?php echo $this->lang->line('username'); ?></span>
									<input type="text" name="username" id="username"  />
								</label>
								<label>
									<span><?php echo $this->lang->line('password'); ?><a href="<?php echo base_url().$this->lang->lang().'/candidate/forgetPassword';?>"><?php echo $this->lang->line('forgot_you_password'); ?></a></span>
									<input type="password" name="password" id="password"  />
								</label>
								<div class="clear"></div>
								<a href="javascript:submitLoginForm()" class="submit"></a>
