		...
		<div class="content">
			...
			<div id="main">
				<div class="main-title">
					<div class="hint"><?php echo $this->lang->line('alumnis_welcome'); ?></div>
					<h1><?php echo $this->lang->line('welcome').' '.$this->session->userdata('alumni_session')->username; ?></h1>
					<div class="main-body">
                                    ...
                                    <div style="width:50%; float:left" align="center">
                                        <a href="<?php echo base_url().$this->lang->lang();?>/alumni/profile"><img src="<?php echo base_url();?>css/old/images/Giza-img-editprofile.jpg" border="0" /></a>
                                    </div>
                                    
                                    <div style="width:50%; float:left" align="center">
                                        <a href="<?php echo base_url().$this->lang->lang();?>/alumni/logout"><img src="<?php echo base_url();?>css/old/images/logout.png" border="0" /></a>	
                                    </div>
