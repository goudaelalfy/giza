...
<div class="pagination" >
	...
	<?php 
            	...
            	if($previous_lnk>0)
            	{
            		echo "<a href='".base_url().$this->lang->lang()."/search/advancedResult/$previous_lnk?keyword=$keyword&$target'> « ‹ </a> ";
            	}
            	...
            	for ($counter = 0; $counter < $pages; $counter += 1) 
            	{
            		...
            		{
            			echo " <a href='".base_url().$this->lang->lang()."/search/advancedResult/$page_no?keyword=$keyword&$target' $class_style>$page_no</a> ";
            		}
            	}
            	...
            	if($next_lnk<=$pages)
            	{
            		echo " <a href='".base_url().$this->lang->lang()."/search/advancedResult/$next_lnk?keyword=$keyword&$target' > › » </a>";
            	}
            	?>
