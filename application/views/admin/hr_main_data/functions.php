...
class Functions {
   ...
   public function __construct() {
	...
	public function display_data_table($table, $array_of_data,$link_to_screen='',$object) 
	{

		echo "
		<script type='text/javascript'  src='".base_url()."js/includes/functions.js' > </script>
		<script type='text/javascript'  src='".base_url()."js/admin/hrmaindata/form.js' > </script>
		";
		...
		foreach ($array_of_data as $record)
		{
			$count_of_records=count($array_of_data);
				...
				echo"<a class='btn btn-danger' href='$link_to_screen/delete/$current_row_id/$table' onclick='return delete_confirm(\"".$object->lang->lang()."\")'>
