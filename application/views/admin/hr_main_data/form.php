...
<script type='text/javascript'  src='<?php echo base_url();?>js/admin/hrmaindata/form.js' > </script>
...
if($mode!='add')
{
	...
	if($mode=='return')
	{
		...
		//$hr_main_table=			$current_row['hr_main_table'];	
...
<h2><i class="icon-edit"></i> <?php echo lang('hr_main_data')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_hrmaindata_row' name='frm_hrmaindata_row'  method='post' enctype='multipart/form-data'>
...
<input type="hidden" name="last_modify_date" id="last_modify_date" value="<?php echo $last_modify_date; ?>"> 
	...
	<a class='btn btn-success' href='<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/hrmaindata/table'>
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/hrmaindata/form/0/add/<?php echo $hr_main_table;?>">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/hrmaindata/form/<?php echo $id;?>/edit/<?php echo $hr_main_table;?>">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/hrmaindata/delete/<?php echo $id;?>/<?php echo $hr_main_table;?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
...
<div class="controls">
<?php $dropdowns->drpdwn_hr_tables($this_object, $hr_main_table,'hr_main_table', $are_disabled); ?>

<div class="dv_error" id="dv_hr_main_table_false" style="display:none; "><?php echo lang('hr_main_table_false'); ?></div>
