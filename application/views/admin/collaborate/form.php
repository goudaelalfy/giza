...
<script type='text/javascript'  src='<?php echo base_url();?>js/admin/collaborate/form.js' > </script>
...
/**
 * Collaborate controller object.
 * 
 * Intialize object from Collaborate controller class.
 * @var object.
 */

$this_object= new Collaborate();
...
$("#dv_username_true").html('');
    $.ajax({  
    type: "POST",  
    url: "<?php echo base_url().$this->lang->lang().'/'.ADMIN; ?>/collaborate/check_username_availability/<?php echo $id; ?>",  
    data: "username="+ usr,  
...
<h2><i class="icon-edit"></i> <?php echo lang('collaborates')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_collaborate_row' name='frm_collaborate_row'  method='post' enctype='multipart/form-data'>
...
<input type="hidden" name="last_modify_date" id="last_modify_date" value="<?php echo $last_modify_date; ?>"> 
	...
	<a class='btn btn-success' href='<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/collaborate/table'>
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/collaborate/form/0/add">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/collaborate/form/<?php echo $id;?>/edit">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/collaborate/delete/<?php echo $id;?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
...
<br/>
							  ...
							  <div class="control-group">
								...
								<div class="dv_error"  id="dv_email_false" style="display:none;"><?php echo lang('email_false'); ?></div>
							  	...
							  	<div class="control-group">
								<label class="control-label" for="focusedInput"><?php echo lang('type'); ?></label>
								<div class="controls">
								<select class="name" name="type" id="type" >
                                            	<option value="">-- <?php echo lang('select_type'); ?> --</option>
                                                <option value="Inspiring Change" <?php if($type=='Inspiring Change'){echo "selected='selected'";} ?>>Inspiring Change</option>	
                                                <option value="Going Green" <?php if($type=='Going Green'){echo "selected='selected'";} ?>>Going Green</option>	
                                                <option value="Driving Innovation" <?php if($type=='Driving Innovation'){echo "selected='selected'";} ?>>Driving Innovation</option>	
                                                <option value="Corporate Governance" <?php if($type=='Corporate Governance'){echo "selected='selected'";} ?>>Corporate Governance</option>
								...
								<div class="controls">
								  <textarea name="message" id="message" rows="3" cols="30" <?php echo $readonly; ?>> <?php echo $message; ?> </textarea>
								</div>
							  	</div>
