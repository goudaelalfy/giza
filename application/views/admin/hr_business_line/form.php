...
<script type='text/javascript'  src='<?php echo base_url();?>js/admin/businessline/form.js' > </script>
...
/**
 * Businessline controller object.
 * 
 * Intialize object from Businessline controller class.
 * @var object.
 */

$this_object= new Businessline();
...
<h2><i class="icon-edit"></i> <?php echo lang('business_lines')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_businessline_row' name='frm_businessline_row'  method='post' enctype='multipart/form-data'>
...
<input type="hidden" name="last_modify_date" id="last_modify_date" value="<?php echo $last_modify_date; ?>"> 
	...
	<a class='btn btn-success' href='<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/businessline/table'>
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/businessline/form/0/add">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/businessline/form/<?php echo $id;?>/edit">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/businessline/delete/<?php echo $id;?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
