...
<script type='text/javascript'  src='<?php echo base_url();?>js/admin/client/form.js' > </script>
...
if(!isset($client_industry_ids)) {
$client_industry_ids=		'';
}
if(!isset($client_industry_names)) {
$client_industry_names=	'';
}
if(!isset($client_project_industry_ids)) {
$client_project_industry_ids=		'';
}
if(!isset($client_project_industry_names)) {
$client_project_industry_names=	'';
}
...
if($mode!='add')
{
	...
	if($mode=='return')
	{
		...
		$client_industry_ids=	$current_row['client_industry_ids'];
		$client_industry_names=$current_row['client_industry_names'];
		$client_project_industry_ids=		$current_row['client_project_industry_ids'];
		$client_project_industry_names=	$current_row['client_project_industry_names'];
	...
	else 
	{
		...
		$client_industry_names=$client_industry_names;
		$client_project_industry_ids=		$client_project_industry_ids;
		$client_project_industry_names=	$client_project_industry_names;
	}
...
$("#dv_username_true").html('');
    $.ajax({  
    type: "POST",  
    url: "<?php echo base_url().$this->lang->lang().'/'.ADMIN; ?>/client/check_username_availability/<?php echo $id; ?>",  
    data: "username="+ usr,  
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/client/form/0/add">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/client/form/<?php echo $id;?>/edit">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/client/delete/<?php echo $id;?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
...
<input type="hidden" name="industry_ids" id="industry_ids" value="<?php echo $client_industry_ids; ?>"> 
<input class="input-xlarge focused" type="text" readonly="readonly" name="industry_names" id="industry_names" value="<?php echo $client_industry_names; ?>" style="width:400px;">
<a class='btn btn-primary' href='javascript:void(0)' onclick="PopupCenter('<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/client/popupindustry/<?php echo $id;?>' , '<?php echo $this->lang->line('select_client_industrys')?>',400,500);" >::::</a>
...
<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('project_industries'); ?></label>
<div class="controls">
<div style="width:690px">
<input type="hidden" name="project_industry_ids" id="project_industry_ids" value="<?php echo $client_project_industry_ids; ?>"> 
<input class="input-xlarge focused" type="text" readonly="readonly" name="project_industry_names" id="project_industry_names" value="<?php echo $client_project_industry_names; ?>" style="width:400px;">
<a class='btn btn-primary' href='javascript:void(0)' onclick="PopupCenter('<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/client/popupprojectindustry/<?php echo $id;?>' , '<?php echo $this->lang->line('select_client_project_industrys')?>',400,500);" >::::</a>
<div class="dv_error"  id="dv_project_industry_ids_false" style="display:none;"><?php echo lang('project_industry_ids_false'); ?></div>
</div>
</div>
</div>			
...
<br/>
							...
							<div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" type="text" <?php echo $readonly; ?> name="project_name" id="project_name" value="<?php echo $project_name; ?>">
								<div class="dv_error" id="dv_project_name_false" style="display:none"><?php echo lang('project_name_false'); ?></div>							
								</div>
							  </div>
							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput"><?php echo lang('project_contract_value'); ?></label>
								<div class="controls">
								  <input class="input-xlarge focused" type="text" <?php echo $readonly; ?> name="project_contract_value" id="project_contract_value" value="<?php echo $project_contract_value; ?>">
								<div class="dv_error" id="dv_project_contract_value_false" style="display:none"><?php echo lang('project_contract_value_false'); ?></div>							
								</div>
							  </div>
							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput"><?php echo lang('project_duration'); ?></label>
								<div class="controls">
								  <input class="input-xlarge focused" type="text" <?php echo $readonly; ?> name="project_duration" id="project_duration" value="<?php echo $project_duration; ?>">
								<div class="dv_error" id="dv_project_duration_false" style="display:none"><?php echo lang('project_duration_false'); ?></div>							
								</div>
							  </div>
							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput"><?php echo lang('testimony'); ?></label>
								<div class="controls">
								  <input class="input-xlarge focused" type="text" <?php echo $readonly; ?> name="testimony" id="testimony" value="<?php echo $testimony; ?>">
								<div class="dv_error" id="dv_testimony_false" style="display:none"><?php echo lang('testimony_false'); ?></div>							
								</div>
							  </div>
							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput"><?php echo lang('feedback'); ?></label>
								<div class="controls">
								  <input class="input-xlarge focused" type="text" <?php echo $readonly; ?> name="feedback" id="feedback" value="<?php echo $feedback; ?>">
								<div class="dv_error" id="dv_feedback_false" style="display:none"><?php echo lang('feedback_false'); ?></div>							
								</div>
							  </div>
