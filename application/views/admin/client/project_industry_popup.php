...
{
	window.opener.document.getElementById('project_industry_ids').value=industry_id;
	window.opener.document.getElementById('project_industry_names').value=industry_name;
...
function selectIndustries() 
{
		...
		var project_industry_ids='';
		var project_industry_names='';
		var counter=0;
		...
		for (var i = 0; i < document.frm_popup.elements.length; i++ ) 
	    {
		    ...
		    {		   
	        	...
	        	if(document.frm_popup.elements[i].checked)
	        	{
		        	if(counter==0)
		        	{
		        		project_industry_ids=project_industry_ids+document.frm_popup.elements[i].value;
		        		project_industry_names=project_industry_names+document.frm_popup.elements[i].name;
		        	}
		        	else
		        	{
		        		project_industry_ids=project_industry_ids+','+document.frm_popup.elements[i].value;
		...
		window.opener.document.getElementById('project_industry_ids').value=project_industry_ids;
		window.opener.document.getElementById('project_industry_names').value=project_industry_names;
