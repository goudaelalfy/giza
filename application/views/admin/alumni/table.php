...
<form id="frm_display_data" name="frm_display_data" action="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/alumni/submit_display" method="post">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo lang('alumnies')?> </h2>
						<div class="box-icon">
...
<?php 
$this->load->view('admin/alumni/functions');
$functions = new Functions();
$link_to_screen=base_url().$this->lang->lang()."/".ADMIN."/alumni";
...
?>
	...
	<?php 
            	...
            	if($previous_lnk>0)
            	{
            		echo "<li><a href='".base_url().$this->lang->lang()."/".ADMIN."/alumni/table/$previous_lnk'> ".lang('lnk_prev')."</a></li>";
            	}
            	...
            	for ($counter = 0; $counter < $pages; $counter += 1) 
            	{
            		...
            		{
            			echo "<a href='".base_url().$this->lang->lang()."/".ADMIN."/alumni/table/$page_no' $class_style>$page_no</a>";
            		}
            	}
            	...
            	if($next_lnk<=$pages)
            	{
            		echo "<a href='".base_url().$this->lang->lang()."/".ADMIN."/alumni/table/$next_lnk' >".lang('lnk_next')." </a>";
            	}
            	?>
