...
<form id="frm_display_data" name="frm_display_data" action="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/menulink/delete_all" method="post">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo lang('menu_links')?> </h2>
						<div class="box-icon">
...
<?php 
$this->load->view('admin/menu_link/functions');
$functions = new Functions();
$link_to_screen=base_url().$this->lang->lang()."/".ADMIN."/menulink";
