...
<form id="frm_display_data" name="frm_display_data" action="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/job/delete_all" method="post">
...
?>
	...
	<?php 
            	...
            	if($previous_lnk>0)
            	{
            		echo "<li><a href='".base_url().$this->lang->lang()."/".ADMIN."/job/table/$previous_lnk'> ".lang('lnk_prev')."</a></li>";
            	}
            	...
            	for ($counter = 0; $counter < $pages; $counter += 1) 
            	{
            		...
            		{
            			echo "<a href='".base_url().$this->lang->lang()."/".ADMIN."/job/table/$page_no' $class_style>$page_no</a>";
            		}
            	}
            	...
            	if($next_lnk<=$pages)
            	{
            		echo "<a href='".base_url().$this->lang->lang()."/".ADMIN."/job/table/$next_lnk' >".lang('lnk_next')." </a>";
            	}
            	?>
