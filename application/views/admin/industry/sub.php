...
$("#dv_alias_true").html('');
    $.ajax({  
    type: "POST",  
    url: "<?php echo base_url().$this->lang->lang().'/'.ADMIN; ?>/industry/check_alias_sub_availability/<?php echo $industry_id; ?>/<?php echo $sub_id; ?>",  
    data: "alias="+ alias,  
...
<form class="form-horizontal" id='frm_industry_sub_row' name='frm_industry_sub_row'  method='post' action="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/industry/sub" enctype='multipart/form-data'>

<input type="hidden" name="sub_id" id="sub_id" value="<?php echo $sub_id; ?>">
<input type="hidden" name="industry_id" id="industry_id" value="<?php echo $industry_id; ?>">
...
<input type="hidden" name=" hdn_banner_files" id=" hdn_banner_files" value="<?php echo $banner_files; ?>"> 
	...
	<a class='btn btn-success' href='<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/industry/form/<?php echo $industry_id?>/edit'>
				<i class='icon-zoom-in icon-white'></i>  
				<?php  echo $this->lang->line('return_industry'); ?>                                           
	</a>
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/industry/sub/<?php echo $industry_id?>/<?php echo $sub_id?>/add">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/industry/sub/<?php echo $industry_id?>/<?php echo $sub_id?>/edit">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/industry/deletesub/<?php echo $sub_id?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
