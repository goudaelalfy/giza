...
class MY_Model extends CI_Model
{
	...
	*/
	...
	function get_all_including_deleted($table='')
	{
		if($table=='') {
			$table=$this->table;
		}
	...
	function get_all_approved($table='', $sort_field=null, $sort_type=null)
	{
		if($table=='') {
			$table=$this->table;
		}
	...
	/**
	 * Get records count by condition Method.
	 *
	 * Method to return count of record from table by condition
	 * @access	public
	 * @param   string
	 * @return	int
	 */
	function get_count_by_condition($condition)
    {
	...
	/**
	 * Get All Record by condition Method.
	 *
	 * Method to return all record from specific table by passing condition. 
	 *
	 * @access	public
	 * @param   string
	 * @return	std class array
	 */
	function get_all_by_condition($condition)
	{
	    $this->db->select('*');
	    $this->db->where($condition);
