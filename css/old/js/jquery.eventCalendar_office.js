	...
	flags.wrap.find('.eventsCalendar-list .eventTitle').live('click',function(e){
		if(!eventsOpts.showDescription) {
			...
			if (!desc.find('a').size()) {
				...
				desc.append('<a href="' + eventUrl +'&i=1&selected_footeritem_id=4&selected_sub_footeritem_id=13" id="various1" class="bt" >'+eventsOpts.txt_GoToEventUrl+'</a>')
			} 
...
$jQuery.fn.eventCalendar.defaults = {
	...
	txt_noEvents: "There are no events in this month",
