...
class UploadHandler
{
    ...
    function __construct($file='', $options = null, $initialize = true) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME'])."/added/uploads/gallery/$file/",
            'upload_url' => $this->get_full_url()."/added/uploads/gallery/$file/",
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
